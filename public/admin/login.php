...
if ($_SERVER['REQUEST_METHOD']==='POST') {
    try { Security::csrf(); Security::login($app,Http::text($_POST,'password',1024)); Http::redirect($app->path('/admin/')); }
