...
final class TelegramApi
{
    ...
    {
        if (!in_array($method,['getMe','getUpdates','setWebhook','deleteWebhook','getWebhookInfo','sendMessage','copyMessage','getChat','deleteMessage','answerCallbackQuery'],true)) throw new \LogicException('Unsupported Telegram method');
