...
<p class="muted compact">Token 仅存于服务器私有目录，页面不回显。更换机器人或管理员会清空原会话关联与屏蔽列表。</p>
...
<p class="muted compact">若 Telegram 限制账号与机器人交流，仍以平台实际提示为准。消息仅在用户主动联系后回复，不包含群发功能。</p></section></div>
